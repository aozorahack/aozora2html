...
class DakutenKatakanaTagTest < Test::Unit::TestCase
  ...
  def test_dakuten_katakana_new
    tag = Aozora2Html::Tag::DakutenKatakana.new(@parser, 1, 'ア', gaiji_dir: @gaiji_dir)
  ...
  def test_to_s
    tag = Aozora2Html::Tag::DakutenKatakana.new(@parser, 1, 'ア', gaiji_dir: @gaiji_dir)
    assert_equal '<img src="g_dir/1-07/1-07-81.png" alt="※(濁点付き片仮名「ア」、1-07-81)" class="gaiji" />', tag.to_s
  end
end
